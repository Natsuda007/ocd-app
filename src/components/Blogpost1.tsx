        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยณัฐสุดา ศิระปัญญาธรรม</p>
              <hr />
              {/* Post Content */}
                ...
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "square" }}>
                    <li>
                      ...
                      การเปลี่ยนแปลงเพื่อเพิ่มความสามารถของบุคลากร
                    </li>
                    <li>
                      ถ่ายทอดความรู้
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "square" }}>
                    <li>
                      Action Research
                      (การวิจัยเชิงปฏิบัติการ)เป็นกระบวนการที่ดำเนินต่อเนื่องจากขั้นตอนแรกไปจนถึงขั้นตอนสุดท้าย
                  ...
                  <ul className="ml-4" style={{ listStyleType: "square" }}>
                    <li>
                      การกำหนดประเด็น(En-tering)การรวบรวมข้อมูลขององค์การได้จาก
                      การสังเกตพฤติกรรมการทำงาน การสัมภาษณ์ ฯลฯ
                    </li>
                    การทำข้อตกลง (Con-tracting)ความคาดหวังของทั้งสองฝ่าย
                    (Expectation of the Parties) องค์การระบุผลลัพธ์ที่ได้
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "dics" }}>
              ...
              <p>
                บุคคลที่มีบทบาทต่อการเปลี่ยนแปลงองค์การ คือ
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                  <li>
                  ...
                  <li>
                    พนักงานและผู้จัดการ (Staff and
                    Managers)ใช้ความเชี่ยวชาญของตนในการช่วยรักษาผลของการเปลี่ยนแปลง
                  </li>
                </ul>
              </p>
              <p className="lead">
              ...
              <p>
                ที่ปรึกษาภายในและภายนอก มีดังนี้
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
                  <li>
              ...
              <p>
                ทักษะและความสามารถของที่ปรึกษาด้านการพัฒนาองค์การจะต้องประกอบด้วยดังนี้
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
              ...
              <p>
                จริยธรรมของที่ปรึกษาด้านการพัฒนาองค์การ มีดังนี้
                <ul className="ml-4" style={{ listStyleType: "decimal" }}>
