        ...
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="card h-100">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    การบริหารงาน คือ กระบวนการบริหารเชิงยุทธศาสตร์
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                <a href="#">
                  <img className="card-img-top" src="images/p20.jpg" alt="" />
                </a>
                <div className="card-body">
                  <h4 className="card-title">
                    <a href="assets/technostructure/technostructure-33-54.pdf">
                      การ Coaching
                    </a>
                  </h4>
                  <p className="card-text">
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a href="assets/technostructure/technostructure-55-77.pdf">
                      การสร้างทีม
                    </a>
                  </h4>
                  <p className="card-text">
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a href="assets/technostructure/technostructure-78-123.pdf">
